...
function changedFiles() {
  // Historical Stage 9 scope is pinned to its commit range; functional checks
  // below still read the current cumulative branch.
  return execFileSync("git", ["diff", "--name-only", "9aff28e..540cfe"], { cwd: repoRoot, encoding: "utf8" })
    .split(/\r?\n/)
    .filter(Boolean);
}
